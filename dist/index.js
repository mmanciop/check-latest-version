...
const github_releases_1 = __nccwpck_require__(7441);
const npm_1 = __nccwpck_require__(9466);
const pypi_1 = __nccwpck_require__(5192);
function getLatestPackageVersionFunction(packageManager) {
    switch (packageManager) {
        case 'github-releases':
            return github_releases_1.getLatestGitHubRelease;
        case 'npm':
            return npm_1.getLatestNpmPackageVersion;
        case 'pypi':
            return pypi_1.getLatestPypiPackageVersion;
        default:
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const latestPackageVersionFunction = getLatestPackageVersionFunction(packageManager);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getLatestGitHubRelease = void 0;
const core = __importStar(__nccwpck_require__(2186));
const common_1 = __nccwpck_require__(1794);
function getLatestGitHubRelease(repositoryName) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield (0, common_1.getUrl)(`https://api.github.com/repos/${repositoryName}/releases`);
        const githubReleases = JSON.parse(response) || [];
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getLatestNpmPackageVersion = void 0;
const common_1 = __nccwpck_require__(1794);
function getLatestNpmPackageVersion(packageName) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield (0, common_1.getUrl)(`https://registry.npmjs.org/${packageName}`);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getLatestPypiPackageVersion = void 0;
const core = __importStar(__nccwpck_require__(2186));
const common_1 = __nccwpck_require__(1794);
const rss_parser_1 = __importDefault(__nccwpck_require__(6946));
function getLatestPypiPackageVersion(packageName) {
    return __awaiter(this, void 0, void 0, function* () {
        const rssFeedUrl = `https://pypi.org/rss/project/${packageName}/releases.xml`;
        core.debug(`Fetching the PIP RSS feed at: ${rssFeedUrl}`);
        const response = yield (0, common_1.getUrl)(rssFeedUrl);
        const feed = yield new rss_parser_1.default().parseString(response.toString());
...
exports.getLatestPypiPackageVersion = getLatestPypiPackageVersion;
